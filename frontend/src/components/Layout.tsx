...
import { LayoutDashboard, MessageSquare, Layers, Map, User, LogOut, Menu, X, ChevronDown } from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                {showProfileMenu && (
                  <div className="absolute right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-xl border border-gray-700 py-2 animate-fadeIn z-50">
                    <Link
                      to="/profile"
